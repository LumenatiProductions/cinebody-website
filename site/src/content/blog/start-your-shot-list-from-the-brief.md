...
heroImage: "/blog/start-your-shot-list-from-the-brief/hero.png"
cardImage: "/blog/start-your-shot-list-from-the-brief/card.png"
---
...
<p>Name the filmers. Store staff after close. Customers who already bought the thing. Run-club members with ten minutes before the group leaves. People film differently on the clock than they do at a concert.</p>
<p>Name the setting and the time you actually have. A locker room. A sales floor. A driveway. A festival pit. If they have four minutes, do not write a list that needs twenty.</p>
<p>Name the edit. If you need one line to camera, say so. If you need hands on the product, say so. If you need movement, say the path: walk in, lace up, start the jog. The more the brief sounds like an edit, the more the first list will sound like shots.</p>
...
<figure class="post-figure--phone">
  <img src="/blog/start-your-shot-list-from-the-brief/img-1.png" alt="Phone showing the capture brief.">
</figure>
...
<p>Bad shot: "Show us your workout, talk about why you love the bottle, get a close-up of the logo, and end on a smile."</p>
<p>That is four asks. You will get a ramble, a logo if you are lucky, and no clean in-point.</p>
<p>Better, as four shots:</p>
<ol>
...
<p>Same campaign. Each line is something you can check off.</p>
<p>Tone matters as much as structure.</p>
...
<figure class="post-figure--wide">
  <img src="/blog/start-your-shot-list-from-the-brief/img-2.png" alt="Desktop wizard with the generated shot list.">
</figure>
...
<p>Now do the producer pass. If the line to camera is the hero of the cut, move it to shot one. People drop off. The first ask is the one you keep. If ten minutes is real, cut the wide. You can live without it. You cannot live without the lace-up and the line.</p>
<p>Rewrite shot 3 so it does not feel like a test. "Whenever you are ready, look at us and tell us one thing about how it feels. One sentence is perfect." Same ask. Better ask.</p>
<p>Do not add the box, the storefront, a group shot, and a sunset because the brief mentioned a launch. That is how a five-shot list becomes homework.</p>
