...
---
<p>A shot list is the set of asks you send the people filming a UGC campaign. It is what makes the footage editable later. If the list is vague, you get atmosphere and not much you can cut. If it is long, people stop partway through. If one line asks for five things, you often get the first thing and a lot of leftover motion.</p>
...
<p>Here is a brief that is usable, and a shot that tries to do too much.</p>
<p>Brief: "Customers film a quick review of the new bottle after a workout."</p>
<p>Overloaded shot: "Show us your workout, talk about why you love the bottle, get a close-up of the logo, and end on a smile."</p>
<p>That line is four asks. In practice you often get a ramble, a logo if you are lucky, and no clean place to start the clip in an edit.</p>
<p>The same brief, split into four shots:</p>
<ol>
  <li>Hold the bottle at chest height and take a sip. Keep it casual.</li>
  <li>Tilt down to your hands and unscrew the lid. Slow is fine.</li>
...
<p>"Stand near the entrance and film people walking in for ten seconds. You do not need to talk."</p>
<p>The first describes a feeling. The second describes a place, a duration, and whether they need to speak. Warm here does not mean vague. It means the person filming can tell they are being directed, not graded.</p>
<p>If a first-draft shot looks like the overloaded examples, rewrite it before anyone else sees the list. A draft from a brief is there so you are not staring at an empty field. It is not finished direction until you edit it.</p>
<h2>How to read the first draft</h2>
<p>Use the same checks you would use on a list you wrote by hand.</p>
<p>Length. One to five shots is the range most people will actually film. Seven only if you have a reason. A brief can describe a whole campaign. The list filmers see cannot.</p>
<p>One ask. If a line has "and," it is often two shots. Split them.</p>
<p>Language. "Hold the phone at chest height and walk toward the door" tells someone what to do. "Deliver a dynamic entrance in vertical, branded, and on-brief" does not, even if everyone on the marketing team knows what you meant.</p>
<p>Order. If they only film one clip, it should be the clip you cannot cut without. First drafts often lead with a pretty wide. Put the line to camera, the product in hand, or the moment the night is about at the top.</p>
<p>The earlier post is the longer write-up on those rules. This one is the step in front of them: write a brief, then make a list, then rewrite the list.</p>
...
<p>Imagine a running-shoe launch. Filmers are store staff and a few local run-club people. You need a 30-second social cut by the end of the week. Phones only, after work.</p>
<p>A brief that can support a list:</p>
...
<p>From that, a first pass might look like this:</p>
<ol>
  <li>Sit down, hold the shoe, and lace it up. Stay on your hands.</li>
  <li>Step outside and start a short jog. Phone at chest height. Ten seconds is enough.</li>
